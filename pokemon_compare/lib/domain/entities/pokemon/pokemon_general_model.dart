...
PokemonGeneralModel pokemonGeneralModelFromJson(String str) =>
    PokemonGeneralModel.fromJson(json.decode(str));

String pokemonGeneralModelToJson(PokemonGeneralModel data) =>
  ...
  factory PokemonGeneralModel.fromJson(Map<String, dynamic> json) =>
      PokemonGeneralModel(
        ...
        types: json["types"] == null
            ? []
            : List<TypeAttack>.from(
                json["types"]!.map((x) => TypeAttack.fromJson(x))),
        weight: json["weight"],
      );
...
class TypeAttack {
  ...
  factory TypeAttack.fromJson(Map<String, dynamic> json) => TypeAttack(
        slot: json["slot"],
